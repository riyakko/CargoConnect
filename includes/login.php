<?php
// Includes/login.php - Standalone Login Page to match the custom design
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="right-pane">
        <div class="login-box">
            ...
            <div class="tab-switcher">
                <div class="tab-btn active">LOGIN</div>
                <div class="tab-btn">REGISTER</div>
            </div>
            ...
            <form action="../dashboard.php" method="GET">
                ...
                <div class="mb-4">
                    ...
                    <div class="password-container">
                        ...
                        <i class="fa-solid fa-eye-slash password-toggle" onclick="togglePassword()"></i>
                    </div>
                </div>

                <button type="submit" class="btn-orange mt-2">LOGIN</button>

                <div class="bottom-text">
                    New to CargoConnect? <a href="#">Create a free account</a>
                </div>
            </form>
        </div>
    </div>
