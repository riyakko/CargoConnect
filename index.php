<?php include 'includes/header.php'; ?>
    ...
    <main class="hero-section text-center position-relative pt-5 pb-4" style="background: linear-gradient(180deg, #F0F4F8 0%, #E2E8F0 100%); min-height: 50vh;">
        <div class="container position-relative z-2">
            ...
            <!-- 3D Model Container -->
            <div class="model-container-wrapper mx-auto mt-4 position-relative" style="height: 400px; max-width: 800px;">
                ...
                <div class="glow-effect left-glow" style="background: rgba(249, 115, 22, 0.4); top: 15%; left: 10%; width: 200px; height: 200px; border-radius: 50%; filter: blur(60px); position: absolute; z-index: 0;"></div>
